...
<html>
    <head>
        ...
        <meta name="description" content="Página de cadastro de VIP">
        <meta name="keywords" content="Usuários, VIP, Padrão, Torrent, Filmes, Download">
        <meta name="author" content="Padrão Torrent">
        <title>VIP - Padrão Torrent</title>
